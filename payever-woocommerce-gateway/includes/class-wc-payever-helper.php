...
class WC_Payever_Helper {
	...
	const PAYEVER_B2B_COMPANY_SEARCH                 = 'payever_enable_company_search';
	const PAYEVER_B2B_COUNTRIES                      = 'payever_b2b_countries';
	 ...
	 */
	public function get_b2b_countries() {
		$countries = get_option( self::PAYEVER_B2B_COUNTRIES );
	 ...
	 * @return $this
	 */
	public function set_b2b_countries( $value ) {
		if ( is_array( $value ) ) {
			$value = implode( ',', array_unique( $value ) );
		}
		update_option( self::PAYEVER_B2B_COUNTRIES, $value );
