 ...
 * @method wp_register_style($handle, $src, $deps = array(), $ver = false, $media = 'all')
 * @method wp_enqueue_style($handle, $src = '', $deps = array(), $ver = false, $media = 'all')
 * @method wp_register_script($handle, $src, $deps = array(), $ver = false, $in_footer = false)
 * @method wp_enqueue_script($handle, $src = '', $deps = array(), $ver = false, $in_footer = false)
 * @method wp_localize_script($handle, $object_name, $l10n)
